class DropBoxController {
    ...
    constructor() {
        ...
        this.progressBarEl = this.snakeModalEl.querySelector('.mc-progress-bar-fg')
    ...
    connectFirebase(){
        ...
        var config = {
            apiKey: "AIzaSyBSPJKrc4yyI5fEtobi43PYlR-NanAJEfg",
            authDomain: "dropbox-clone-4d513.firebaseapp.com",
            databaseURL: "https://dropbox-clone-4d513.firebaseio.com",
            projectId: "dropbox-clone-4d513",
            storageBucket: "dropbox-clone-4d513.appspot.com",
            messagingSenderId: "918363092740",
            appId: "1:918363092740:web:f0f3d213f3cb65d2064251"
        };
    ...
    modalShow(show = true) {
        ...
        this.snakeModalEl.style.display = (show) ? 'block' : 'none';
    }
    ...
    formatTimeToHuman(duration) {
        ...
        if (hours > 0) {
            return `${hours} horas, ${minutes} minutos e ${seconds} secondss`;
        }
